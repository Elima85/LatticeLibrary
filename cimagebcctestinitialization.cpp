...
TEST(CImageBCC, operators) {
    ...
    // ()-operator
    returnedVal = (*imBCC)(0, 0, 0, 0);
    EXPECT_NEAR(returnedVal, 1, EPSILONT);
    returnedVal = (*imBCC)(0, 1, 2, 3);
    EXPECT_NEAR(returnedVal, 34, EPSILONT);
    returnedVal = (*imBCC)(nR - 1, nC - 1, nL - 1, nB - 1);
    ...
    */
    ...
    // Exceptions
    EXPECT_THROW((*imBCC)[-1], outsideImageException);
    EXPECT_THROW((*imBCC)[N], outsideImageException);

    EXPECT_THROW((*imBCC)(-1, 0, 0, 0), outsideImageException);
    EXPECT_THROW((*imBCC)(0, -1, 0, 0), outsideImageException);
    EXPECT_THROW((*imBCC)(0, 0, -1, 0), outsideImageException);
    EXPECT_THROW((*imBCC)(0, 0, 0, -1), outsideImageException);
    EXPECT_THROW((*imBCC)(nR, 0, 0, 0), outsideImageException);
    EXPECT_THROW((*imBCC)(0, nC, 0, 0), outsideImageException);
    EXPECT_THROW((*imBCC)(0, 0, nL, 0), outsideImageException);
    EXPECT_THROW((*imBCC)(0, 0, 0, nB), outsideImageException);
