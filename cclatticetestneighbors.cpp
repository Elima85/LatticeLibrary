...
TEST(CCLattice, neighbors) {
    ...
    EXPECT_EQ(neighbors[0].getElementIndex(), CC6[0]);
    EXPECT_EQ(neighbors[1].getElementIndex(), CC6[1]);
    EXPECT_EQ(neighbors[2].getElementIndex(), CC6[2]);
    EXPECT_EQ(neighbors[3].getElementIndex(), CC6[3]);
    EXPECT_EQ(neighbors[4].getElementIndex(), CC6[4]);
    EXPECT_EQ(neighbors[5].getElementIndex(), CC6[5]);
    ...
    lattice->getNeighbors(3, 2, 5, neighborhoodSize, neighbors);
    EXPECT_EQ(neighbors.size(), correctNNeighbors);
    EXPECT_EQ(neighbors[0].getElementIndex(), CC18[0]);
    EXPECT_EQ(neighbors[1].getElementIndex(), CC18[1]);
    EXPECT_EQ(neighbors[2].getElementIndex(), CC18[2]);
    EXPECT_EQ(neighbors[3].getElementIndex(), CC18[3]);
    EXPECT_EQ(neighbors[4].getElementIndex(), CC18[4]);
    EXPECT_EQ(neighbors[5].getElementIndex(), CC18[5]);
    EXPECT_EQ(neighbors[6].getElementIndex(), CC18[6]);
    EXPECT_EQ(neighbors[7].getElementIndex(), CC18[7]);
    EXPECT_EQ(neighbors[8].getElementIndex(), CC18[8]);
    EXPECT_EQ(neighbors[9].getElementIndex(), CC18[9]);
    EXPECT_EQ(neighbors[10].getElementIndex(), CC18[10]);
    EXPECT_EQ(neighbors[11].getElementIndex(), CC18[11]);
    EXPECT_EQ(neighbors[12].getElementIndex(), CC18[12]);
    EXPECT_EQ(neighbors[13].getElementIndex(), CC18[13]);
    EXPECT_EQ(neighbors[14].getElementIndex(), CC18[14]);
    EXPECT_EQ(neighbors[15].getElementIndex(), CC18[15]);
    EXPECT_EQ(neighbors[16].getElementIndex(), CC18[16]);
    EXPECT_EQ(neighbors[17].getElementIndex(), CC18[17]);
    lattice->getNeighbors(lattice->rclToIndex(3, 2, 5), neighborhoodSize, neighbors);
    EXPECT_EQ(neighbors.size(), correctNNeighbors);
    EXPECT_EQ(neighbors[0].getElementIndex(), CC18[0]);
    EXPECT_EQ(neighbors[1].getElementIndex(), CC18[1]);
