...
TEST(CImageFCC, bands) {
    ...
    CImageFCC<double> *imFCC = new CImageFCC<double>(data, nR, nC, nL, nB);
    ...
    int index = 0;
    originalIntensity = (*imFCC)[index];
    imFCC->setElement(index, intensities0);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 0), 0, EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 1), 0, EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 2), 0, EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 3), 0, EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 4), 0, EPSILONT);
    imFCC->setElement(index, intensitiesRight);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 0), intensitiesRight[0], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 1), intensitiesRight[1], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 2), intensitiesRight[2], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 3), intensitiesRight[3], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 4), intensitiesRight[4], EPSILONT);
    imFCC->setElement(index, originalIntensity);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 0), originalIntensity[0], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 1), originalIntensity[1], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 2), originalIntensity[2], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 3), originalIntensity[3], EPSILONT);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 4), originalIntensity[4], EPSILONT);
    index = 1;
    originalIntensity = (*imFCC)[index];
    imFCC->setElement(index, intensities0);
    EXPECT_NEAR((*imFCC)(imFCC->indexToR(index), imFCC->indexToC(index), imFCC->indexToL(index), 0), 0, EPSILONT);
    ...
    EXPECT_THROW(imFCC->setElement(-1, intensitiesRight), outsideImageException);
    EXPECT_THROW(imFCC->setElement(N, intensitiesRight), outsideImageException);
    EXPECT_THROW(imFCC->setElement(1, intensitiesShort), dimensionMismatchException);
    EXPECT_THROW(imFCC->setElement(1, intensitiesLong), dimensionMismatchException);

    EXPECT_THROW(imFCC->setElement(-1, 1, 1, intensitiesRight), outsideImageException);
    EXPECT_THROW(imFCC->setElement(1, -1, 1, intensitiesRight), outsideImageException);
    EXPECT_THROW(imFCC->setElement(1, 1, -1, intensitiesRight), outsideImageException);
    EXPECT_THROW(imFCC->setElement(1, intensitiesShort), dimensionMismatchException);
    EXPECT_THROW(imFCC->setElement(1, intensitiesLong), dimensionMismatchException);
