...
TEST(FCCLattice,coordinates) {
    ...
    FCCLattice *lattice1 = new FCCLattice(nRows, nColumns, nLayers, scaleFactor1);
    FCCLattice *lattice2 = new FCCLattice(nRows, nColumns, nLayers, scaleFactor2);

    // "1D" lattices
    FCCLattice *lattice1Column1Layer = new FCCLattice(nElements, 1, 1, scaleFactor1);
    FCCLattice *lattice1Row1Layer = new FCCLattice(1, nElements, 1, scaleFactor1);
    FCCLattice *lattice1Row1Column = new FCCLattice(1, 1, nElements, scaleFactor1);

    // "2D" lattices
    int n1 = 15;
    int n2 = 14;
    FCCLattice *lattice1Layer = new FCCLattice(n1, n2, 1, scaleFactor1);
    FCCLattice *lattice1Column = new FCCLattice(n1, 1, n2, scaleFactor1);
    FCCLattice *lattice1Row = new FCCLattice(1, n1, n2, scaleFactor1);
