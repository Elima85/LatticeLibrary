...
TEST(CImageBCC, downsample) { // may need a 6 layer image, so that all neighbors exist for the 8 middle spels.
    ...
    CImageCC<double> *HighRes1 = new CImageCC<double>(data1, nRHighRes, nCHighRes, nLHighRes, 1, pow(0.01 * FCCPOINTDISTANCE, 3) + 0.000000001 * EPSILONT);
    CImageCC<double> *HighRes2 = new CImageCC<double>(data2, nRHighRes, nCHighRes, nLHighRes, 1, pow(0.01 * FCCPOINTDISTANCE, 3) + 0.000000001 * EPSILONT);
    CImageCC<double> *HighRes3 = new CImageCC<double>(data3, nRHighRes, nCHighRes, nLHighRes, 1, pow(0.01 * FCCPOINTDISTANCE, 3) + 0.000000001 * EPSILONT);
    CImageCC<double> *HighRes4 = new CImageCC<double>(data4, nRHighRes, nCHighRes, nLHighRes, 2, pow(0.01 * FCCPOINTDISTANCE, 3) + 0.000000001 * EPSILONT);
    ...
    EXPECT_EQ(4, imFCCLowRes1->getNRows());
    ...
    EXPECT_EQ(4, imFCCLowRes2->getNRows());
    ...
    EXPECT_EQ(4, imFCCLowRes3->getNRows());
    ...
    EXPECT_EQ(4, imFCCLowRes4->getNRows());
    ...
    EXPECT_THROW(imFCCVeryLowRes->downsample(HighRes1, 10), downsampleException);
