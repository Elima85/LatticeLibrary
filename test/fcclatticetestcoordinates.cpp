...
TEST(FCCLattice,coordinates) {
    ...
    EXPECT_NEAR(lattice1.indexToX(135), 0.0 + 6 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToY(135), 0.0 + FCCPOINTDISTANCE, EPSILONT);
    EXPECT_NEAR(lattice1.indexToZ(135), 0.0 + 2 * FCCPOINTDISTANCE, EPSILONT);
    EXPECT_NEAR(lattice1.indexToX(80), 0.0 + 5 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToY(80), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToZ(80), 0.0 + 2 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToX(105), 0.0 + 7 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToY(105), 0.0 + 2 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToZ(105), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToX(110), 0.0 + 4 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToY(110), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToZ(110), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToX(209), 0.0 + 10 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToY(209), 0.0 + 4 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(lattice1.indexToZ(209), 0.0 + 6 * FCCOFFSET, EPSILONT);
    ...
    EXPECT_NEAR(coordinates[0], 0.0 + 6 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(coordinates[1], 0.0 + FCCPOINTDISTANCE, EPSILONT);
    EXPECT_NEAR(coordinates[2], 0.0 + 2 * FCCPOINTDISTANCE, EPSILONT);
    lattice1.getCoordinates(209, coordinates);
    EXPECT_NEAR(coordinates[0], 0.0 + 10 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(coordinates[1], 0.0 + 4 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(coordinates[2], 0.0 + 6 * FCCOFFSET, EPSILONT);

    EXPECT_NEAR(lattice2.indexToX(0), scaleFactor2 * 0.0, EPSILONT);
    EXPECT_NEAR(lattice2.indexToY(0), scaleFactor2 * 0.0, EPSILONT);
    EXPECT_NEAR(lattice2.indexToZ(0), scaleFactor2 * 0.0, EPSILONT);
    EXPECT_NEAR(lattice2.indexToX(135), scaleFactor2 * (0.0 + 6 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToY(135), scaleFactor2 * (0.0 + FCCPOINTDISTANCE), EPSILONT);
    EXPECT_NEAR(lattice2.indexToZ(135), scaleFactor2 * (0.0 + 2 * FCCPOINTDISTANCE), EPSILONT);
    EXPECT_NEAR(lattice2.indexToX(80), scaleFactor2 * (0.0 + 5 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToY(80), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToZ(80), scaleFactor2 * (0.0 + 2 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToX(105), scaleFactor2 * (0.0 + 7 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToY(105), scaleFactor2 * (0.0 + 2 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToZ(105), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToX(110), scaleFactor2 * (0.0 + 4 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToY(110), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToZ(110), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToX(209), scaleFactor2 * (0.0 + 10 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToY(209), scaleFactor2 * (0.0 + 4 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(lattice2.indexToZ(209), scaleFactor2 * (0.0 + 6 * FCCOFFSET), EPSILONT);
