...
TEST(Image, coordinates) {
    ...
    CCLattice *latticeCC1 = new CCLattice(nRows, nColumns, nLayers, density1);
    CCLattice *latticeCC2 = new CCLattice(nRows, nColumns, nLayers, density2);
    BCCLattice *latticeBCC1 = new BCCLattice(nRows, nColumns, nLayers, density1);
    BCCLattice *latticeBCC2 = new BCCLattice(nRows, nColumns, nLayers, density2);
    FCCLattice *latticeFCC1 = new FCCLattice(nRows, nColumns, nLayers, density1);
    FCCLattice *latticeFCC2 = new FCCLattice(nRows, nColumns, nLayers, density2);
    ...
    EXPECT_NEAR(imageCC1->indexToX(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToY(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToZ(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToX(170), 0.0 + 2, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToY(170), 0.0 + 3, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToZ(170), 0.0 + 5, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToX(209), 0.0 + 5, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToY(209), 0.0 + 4, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToZ(209), 0.0 + 6, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToX(nElements - 1), 0.0 + nColumns - 1, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToY(nElements - 1), 0.0 + nRows - 1, EPSILONT);
    EXPECT_NEAR(imageCC1->indexToZ(nElements - 1), 0.0 + nLayers - 1, EPSILONT);
    ...
    EXPECT_NEAR(imageBCC1->indexToX(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToY(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToZ(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToX(82), 0.0 + 4 * BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToY(82), 0.0 + 3 * BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToZ(82), 0.0 + BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToX(112), 0.0 + 9 * BCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToY(112), 0.0 + 7 * BCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToZ(112), 0.0 + 3 * BCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToX(209), 0.0 + 5 * BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(imageBCC1->indexToY(209), 0.0 + 4 * BCCSQFACEDISTANCE, EPSILONT); // !!!!!!
    EXPECT_NEAR(imageBCC1->indexToZ(209), 0.0 + 3 * BCCSQFACEDISTANCE, EPSILONT);
    ...
    EXPECT_NEAR(coordinates[0], 0.0 + 4 * BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(coordinates[1], 0.0 + 3 * BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(coordinates[2], 0.0 + BCCSQFACEDISTANCE, EPSILONT);
    imageBCC1->getCoordinates(112, coordinates);
    EXPECT_NEAR(coordinates[0], 0.0 + 9 * BCCOFFSET, EPSILONT);
    EXPECT_NEAR(coordinates[1], 0.0 + 7 * BCCOFFSET, EPSILONT);
    EXPECT_NEAR(coordinates[2], 0.0 + 3 * BCCOFFSET, EPSILONT);
    imageBCC1->getCoordinates(209, coordinates);
    EXPECT_NEAR(coordinates[0], 0.0 + 5 * BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(coordinates[1], 0.0 + 4 * BCCSQFACEDISTANCE, EPSILONT);
    EXPECT_NEAR(coordinates[2], 0.0 + 3 * BCCSQFACEDISTANCE, EPSILONT);

    EXPECT_NEAR(imageFCC1->indexToX(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToY(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToZ(0), 0.0, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToX(135), 0.0 + 6 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToY(135), 0.0 + FCCPOINTDISTANCE, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToZ(135), 0.0 + 2 * FCCPOINTDISTANCE, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToX(80), 0.0 + 5 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToY(80), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToZ(80), 0.0 + 2 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToX(105), 0.0 + 7 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToY(105), 0.0 + 2 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToZ(105), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToX(110), 0.0 + 4 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToY(110), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToZ(110), 0.0 + 3 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToX(209), 0.0 + 10 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToY(209), 0.0 + 4 * FCCOFFSET, EPSILONT);
    EXPECT_NEAR(imageFCC1->indexToZ(209), 0.0 + 6 * FCCOFFSET, EPSILONT);
    ...
    EXPECT_NEAR(imageCC2->indexToX(0), 0.0 * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToY(0), 0.0 * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToZ(0), 0.0 * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToX(170), (0.0 + 2) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToY(170), (0.0 + 3) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToZ(170), (0.0 + 5) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToX(209), (0.0 + 5) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToY(209), (0.0 + 4) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToZ(209), (0.0 + 6) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToX(nElements - 1), (0.0 + (nColumns - 1)) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToY(nElements - 1), (0.0 + (nRows - 1)) * scaleFactor2, EPSILONT);
    EXPECT_NEAR(imageCC2->indexToZ(nElements - 1), (0.0 + (nLayers - 1)) * scaleFactor2, EPSILONT);

    EXPECT_NEAR(imageBCC2->indexToX(0), scaleFactor2 * (0.0), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToY(0), scaleFactor2 * (0.0), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToZ(0), scaleFactor2 * (0.0), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToX(82), scaleFactor2 * (0.0 + 4 * BCCSQFACEDISTANCE), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToY(82), scaleFactor2 * (0.0 + 3 * BCCSQFACEDISTANCE), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToZ(82), scaleFactor2 * (0.0 + BCCSQFACEDISTANCE), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToX(112), scaleFactor2 * (0.0 + 9 * BCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToY(112), scaleFactor2 * (0.0 + 7 * BCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToZ(112), scaleFactor2 * (0.0 + 3 * BCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToX(209), scaleFactor2 * (0.0 + 5 * BCCSQFACEDISTANCE), EPSILONT);
    EXPECT_NEAR(imageBCC2->indexToY(209), scaleFactor2 * (0.0 + 4 * BCCSQFACEDISTANCE), EPSILONT); // !!!!!!
    EXPECT_NEAR(imageBCC2->indexToZ(209), scaleFactor2 * (0.0 + 3 * BCCSQFACEDISTANCE), EPSILONT);

    EXPECT_NEAR(imageFCC2->indexToX(0), scaleFactor2 * 0.0, EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToY(0), scaleFactor2 * 0.0, EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToZ(0), scaleFactor2 * 0.0, EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToX(135), scaleFactor2 * (0.0 + 6 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToY(135), scaleFactor2 * (0.0 + FCCPOINTDISTANCE), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToZ(135), scaleFactor2 * (0.0 + 2 * FCCPOINTDISTANCE), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToX(80), scaleFactor2 * (0.0 + 5 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToY(80), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToZ(80), scaleFactor2 * (0.0 + 2 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToX(105), scaleFactor2 * (0.0 + 7 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToY(105), scaleFactor2 * (0.0 + 2 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToZ(105), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToX(110), scaleFactor2 * (0.0 + 4 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToY(110), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToZ(110), scaleFactor2 * (0.0 + 3 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToX(209), scaleFactor2 * (0.0 + 10 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToY(209), scaleFactor2 * (0.0 + 4 * FCCOFFSET), EPSILONT);
    EXPECT_NEAR(imageFCC2->indexToZ(209), scaleFactor2 * (0.0 + 6 * FCCOFFSET), EPSILONT);
    ...
    EXPECT_GT(fabs(extractedCCLattice1->getDensity() - extractedCCLattice2->getDensity()), EPSILONT);
    ...
    EXPECT_NEAR(extractedCCLattice1->getDensity(), latticeCC1->getDensity(), EPSILONT);
    ...
    EXPECT_NEAR(extractedCCLattice2->getDensity(), latticeCC2->getDensity(), EPSILONT);
    ...
    EXPECT_NEAR(extractedBCCLattice->getDensity(), latticeBCC1->getDensity(), EPSILONT);
    ...
    EXPECT_NEAR(extractedFCCLattice->getDensity(), latticeFCC1->getDensity(), EPSILONT);
