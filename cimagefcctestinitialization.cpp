...
TEST(CImageFCC, constructor) {
    ...
    EXPECT_EQ(imFCC->getNElements(), N);
    EXPECT_NE(imFCC->getNElements(), N + 1);

    EXPECT_EQ(imFCC->getNColumns(), nC);
    EXPECT_NE(imFCC->getNColumns(), nC + 1);

    EXPECT_EQ(imFCC->getNRows(), nR);
    EXPECT_NE(imFCC->getNRows(), nR + 1);

    EXPECT_EQ(imFCC->getNLayers(), nL);
    EXPECT_NE(imFCC->getNLayers(), nL + 1);

    EXPECT_EQ(imFCC->getNBands(), nB);
    EXPECT_NE(imFCC->getNBands(), nB + 1);
    ...
    // index conversion
    EXPECT_EQ(imFCC->rclToIndex(0, 0, 0), 0);
    EXPECT_EQ(imFCC->rclToIndex(1, 2, 3), 98);
    EXPECT_EQ(imFCC->rclToIndex(nR - 1, nC - 1, nL - 1), N - 1);

    EXPECT_EQ(imFCC->indexToR(0), 0);
    EXPECT_EQ(imFCC->indexToC(0), 0);
    EXPECT_EQ(imFCC->indexToL(0), 0);
    EXPECT_EQ(imFCC->indexToR(98), 1);
    EXPECT_EQ(imFCC->indexToC(98), 2);
    EXPECT_EQ(imFCC->indexToL(98), 3);
    EXPECT_EQ(imFCC->indexToR(N - 1), nR - 1);
    EXPECT_EQ(imFCC->indexToC(N - 1), nC - 1);
    EXPECT_EQ(imFCC->indexToL(N - 1), nL - 1);

    delete imFCC;
}

TEST(CImageFCC, operators) {
    ...
    // ()-operator
    returnedVal = (*imFCC)(0, 0, 0, 0);
    EXPECT_NEAR(returnedVal, 1, EPSILONT);
    returnedVal = (*imFCC)(0, 1, 2, 3);
    EXPECT_NEAR(returnedVal, 34, EPSILONT);
    returnedVal = (*imFCC)(nR - 1, nC - 1, nL - 1, nB - 1);
    ...
    */
    ...
    // Exceptions
    EXPECT_THROW((*imFCC)[-1], outsideImageException);
    EXPECT_THROW((*imFCC)[N], outsideImageException);

    EXPECT_THROW((*imFCC)(-1, 0, 0, 0), outsideImageException);
    EXPECT_THROW((*imFCC)(0, -1, 0, 0), outsideImageException);
    EXPECT_THROW((*imFCC)(0, 0, -1, 0), outsideImageException);
    EXPECT_THROW((*imFCC)(0, 0, 0, -1), outsideImageException);
    EXPECT_THROW((*imFCC)(nR, 0, 0, 0), outsideImageException);
    EXPECT_THROW((*imFCC)(0, nC, 0, 0), outsideImageException);
    EXPECT_THROW((*imFCC)(0, 0, nL, 0), outsideImageException);
    EXPECT_THROW((*imFCC)(0, 0, 0, nB), outsideImageException);
